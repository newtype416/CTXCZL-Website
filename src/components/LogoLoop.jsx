...
export const LogoLoop = memo(({
  logos, speed = 120, direction = 'left', width = '100%', logoHeight = 280, gap = 16,
  ...
  // Drag support
  const dragStateRef = useRef({ isDragging: false, startX: 0, startOffset: 0 });

  const handlePointerDown = useCallback((e) => {
    dragStateRef.current.isDragging = true;
    dragStateRef.current.startX = e.clientX;
    dragStateRef.current.startOffset = 0;
    setIsHovered(true);
  }, []);
